...
ARG SONAR_JSON_PLUGIN=sonar-json-plugin
ARG SONAR_JSON_PLUGIN_VERSION=2.1
...
RUN apk --no-cache add curl unzip && \
    ...
    curl -o $SONARQUBE_PLUGINS/$SONAR_JSON_PLUGIN-$SONAR_JSON_PLUGIN_VERSION.jar -fSL \
      https://github.com/racodond/$SONAR_JSON_PLUGIN/releases/download/$SONAR_JSON_PLUGIN_VERSION/$SONAR_JSON_PLUGIN-$SONAR_JSON_PLUGIN_VERSION.jar && \
